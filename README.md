...
| `check-immutable-releases-enabled` | Checks if immutable releases are enabled to prevent modification of published releases | `_wfc_dotnet-ci-check-immutable-releases-enabled.yml` |
...
- `.github/workflows/_wfc_dotnet-ci-check-immutable-releases-enabled.yml`
